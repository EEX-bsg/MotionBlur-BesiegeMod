...
public class AmplifyMotionEffectBase : MonoBehaviour
{
	...
	public float CameraMotionMult = 0.5f;
	...
	bool CreateMaterials()
	{
		...
		string blurShader = "Assets/AmplifyMotion/Resources/MotionBlurSM" + shaderModel + ".shader";
		string solidVectorsShader = "Assets/AmplifyMotion/Resources/SolidVectors.shader";
		string skinnedVectorsShader = "Assets/AmplifyMotion/Resources/SkinnedVectors.shader";
		string clothVectorsShader = "Assets/AmplifyMotion/Resources/ClothVectors.shader";
		string reprojectionVectorsShader = "Assets/AmplifyMotion/Resources/ReprojectionVectors.shader";
		string combineShader = "Assets/AmplifyMotion/Resources/Combine.shader";
		string dilationShader = "Assets/AmplifyMotion/Resources/Dilation.shader";
		string depthShader = "Assets/AmplifyMotion/Resources/Depth.shader";
		string debugShader = "Assets/AmplifyMotion/Resources/Debug.shader";

		try
		{
			AssetBundle assetBundle = SingleInstance<MotionEffectModCore>.Instance.GetAssetBundle();
			m_blurMaterial = new Material( assetBundle.LoadAsset<Shader>(blurShader) ) { hideFlags = HideFlags.DontSave };
			m_solidVectorsMaterial = new Material( assetBundle.LoadAsset<Shader>( solidVectorsShader ) ) { hideFlags = HideFlags.DontSave };
			m_skinnedVectorsMaterial = new Material( assetBundle.LoadAsset<Shader>( skinnedVectorsShader ) ) { hideFlags = HideFlags.DontSave };
			m_clothVectorsMaterial = new Material( assetBundle.LoadAsset<Shader>( clothVectorsShader ) ) { hideFlags = HideFlags.DontSave };
			m_reprojectionMaterial = new Material( assetBundle.LoadAsset<Shader>( reprojectionVectorsShader ) ) { hideFlags = HideFlags.DontSave };
			m_combineMaterial = new Material( assetBundle.LoadAsset<Shader>( combineShader ) ) { hideFlags = HideFlags.DontSave };
			m_dilationMaterial = new Material( assetBundle.LoadAsset<Shader>( dilationShader ) ) { hideFlags = HideFlags.DontSave };
			m_depthMaterial = new Material( assetBundle.LoadAsset<Shader>( depthShader ) ) { hideFlags = HideFlags.DontSave };
			m_debugMaterial = new Material( assetBundle.LoadAsset<Shader>( debugShader ) ) { hideFlags = HideFlags.DontSave };
		}
		catch ( Exception )
		{
		}
